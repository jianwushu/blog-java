<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="友链网站名称" prop="linkName">
        <el-input
          v-model="queryParams.linkName"
          placeholder="请输入友链网站名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="友链链接" prop="linkUrl">
        <el-input
...
<!--      <el-table-column label="友链id" align="center" prop="linkId" />-->
      <el-table-column label="友链网站名称" align="center" prop="linkName" />
      <el-table-column label="友链链接" align="center" prop="linkUrl" />
      <el-table-column label="友链描述" align="center" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="友链网站名称" prop="linkName">
          <el-input v-model="form.linkName" placeholder="请输入友链网站名称" />
        </el-form-item>
        <el-form-item label="友链链接" prop="linkUrl">
          <el-input v-model="form.linkUrl" placeholder="请输入友链链接" />
        </el-form-item>
        <el-form-item label="友链描述" prop="description">
          <el-input v-model="form.description" placeholder="请输入友链描述" />
        </el-form-item>
      </el-form>
...
<script>
  import { listLink, getLink, delLink, addLink, updLink, exportLink } from "@/api/blog/link";
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            if (this.form.linkId != null) {
              updLink(this.form).then(response => {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除友链编号为"' + linkIds + '"的数据项?', "警告", {
